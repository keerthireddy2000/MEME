    ...
    <div class="col-md-12 col-lg-4 mb-4 mb-lg-0">	
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-3">
             <a  style="font-size: 30px" href="${pageContext.request.contextPath}/increaseQuantity?id=${li.id}">+</a>
             <a  style="font-size: 30px" href="${pageContext.request.contextPath}/decreaseQuantity?id=${li.id}">-</a>
...
<h3>
 <c:if test="${totalPrice>0}">
    <a class="link-primary" href="${pageContext.request.contextPath}/foodPayment?totalPrice=${totalPrice}">Total Price: ${totalPrice} Pay Now</a>
    </c:if> 
</h3>
